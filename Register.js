...
const SIMPLIFIED_TO_TRADITIONAL = {
    ...
    // 补充更多常用繁体字
    '灵': '靈', '魂': '魂', '鬼': '鬼', '神': '神', '仙': '仙', '佛': '佛', '道': '道', '教': '教', '宗': '宗', '派': '派',
    '庙': '廟', '寺': '寺', '观': '觀', '堂': '堂', '院': '院', '宫': '宮', '殿': '殿', '塔': '塔', '楼': '樓', '阁': '閣',
    '亭': '亭', '台': '臺', '榭': '榭', '轩': '軒', '斋': '齋', '室': '室', '厅': '廳', '堂': '堂', '屋': '屋', '房': '房',
    '舍': '舍', '宅': '宅', '居': '居', '所': '所', '处': '處', '场': '場', '地': '地', '址': '址', '位': '位', '点': '點',
    '区': '區', '域': '域', '界': '界', '境': '境', '野': '野', '原': '原', '田': '田', '园': '園', '圃': '圃', '场': '場',
    
    // 更多动词
    '办': '辦', '举': '舉', '搞': '搞', '弄': '弄', '整': '整', '修': '修', '建': '建', '造': '造', '制': '制', '作': '作',
    '产': '產', '生': '生', '发': '發', '展': '展', '创': '創', '新': '新', '改': '改', '变': '變', '换': '換', '替': '替',
    '代': '代', '表': '表', '示': '示', '现': '現', '显': '顯', '露': '露', '出': '出', '现': '現', '来': '來', '去': '去',
    '回': '回', '返': '返', '归': '歸', '还': '還', '送': '送', '迎': '迎', '接': '接', '待': '待', '留': '留', '住': '住',
    '停': '停', '止': '止', '休': '休', '息': '息', '睡': '睡', '醒': '醒', '起': '起', '床': '床', '坐': '坐', '站': '站',
    
    // 更多形容词
    '真': '真', '假': '假', '虚': '虛', '实': '實', '正': '正', '邪': '邪', '善': '善', '恶': '惡', '好': '好', '坏': '壞',
    '优': '優', '劣': '劣', '强': '強', '弱': '弱', '硬': '硬', '软': '軟', '刚': '剛', '柔': '柔', '粗': '粗', '细': '細',
    '密': '密', '疏': '疏', '松': '鬆', '紧': '緊', '严': '嚴', '宽': '寬', '松': '鬆', '活': '活', '死': '死', '生': '生',
    '熟': '熟', '生': '生', '鲜': '鮮', '陈': '陳', '旧': '舊', '新': '新', '老': '老', '嫩': '嫩', '青': '青', '黄': '黃',
    '绿': '綠', '红': '紅', '白': '白', '黑': '黑', '灰': '灰', '蓝': '藍', '紫': '紫', '粉': '粉', '棕': '棕', '橙': '橙',
    
    // 更多名词
    '钱': '錢', '财': '財', '富': '富', '贫': '貧', '穷': '窮', '债': '債', '欠': '欠', '还': '還', '借': '借', '贷': '貸',
    '存': '存', '取': '取', '付': '付', '收': '收', '支': '支', '出': '出', '入': '入', '账': '賬', '单': '單', '据': '據',
    '票': '票', '证': '證', '照': '照', '片': '片', '像': '像', '图': '圖', '画': '畫', '字': '字', '文': '文', '章': '章',
    '书': '書', '本': '本', '册': '冊', '卷': '卷', '页': '頁', '张': '張', '纸': '紙', '笔': '筆', '墨': '墨', '砚': '硯',
    '台': '臺', '桌': '桌', '椅': '椅', '凳': '凳', '床': '床', '柜': '櫃', '箱': '箱', '包': '包', '袋': '袋', '盒': '盒',
    
    // 更多科技词汇
    '码': '碼', '编': '編', '程': '程', '序': '序', '件': '件', '体': '體', '统': '統', '库': '庫', '据': '據', '息': '息',
    '号': '號', '码': '碼', '密': '密', '钥': '鑰', '匙': '匙', '锁': '鎖', '开': '開', '关': '關', '启': '啟', '停': '停',
    '运': '運', '行': '行', '执': '執', '处': '處', '理': '理', '器': '器', '机': '機', '设': '設', '备': '備', '施': '施',
    '置': '置', '配': '配', '装': '裝', '卸': '卸', '载': '載', '录': '錄', '存': '存', '储': '儲', '备': '備', '份': '份',
    '复': '復', '制': '制', '印': '印', '刷': '刷', '扫': '掃', '描': '描', '绘': '繪', '画': '畫', '制': '製', '图': '圖',
    
    // 更多网络用语
    '线': '線', '网': '網', '站': '站', '点': '點', '页': '頁', '面': '面', '链': '鏈', '接': '接', '连': '連', '通': '通',
    '断': '斷', '开': '開', '关': '關', '启': '啟', '停': '停', '暂': '暫', '停': '停', '继': '繼', '续': '續', '恢': '恢',
    '复': '復', '修': '修', '复': '復', '更': '更', '新': '新', '升': '升', '级': '級', '降': '降', '级': '級', '回': '回',
    '滚': '滾', '退': '退', '版': '版', '本': '本', '号': '號', '码': '碼', '标': '標', '签': '簽', '记': '記', '号': '號',
    
    // 更多时间词汇
    '钟': '鐘', '表': '錶', '时': '時', '刻': '刻', '分': '分', '秒': '秒', '瞬': '瞬', '间': '間', '刹': '剎', '那': '那',
    '瞬': '瞬', '息': '息', '顷': '頃', '刻': '刻', '霎': '霎', '时': '時', '忽': '忽', '然': '然', '突': '突', '然': '然',
    '忽': '忽', '地': '地', '猛': '猛', '地': '地', '急': '急', '忙': '忙', '匆': '匆', '忙': '忙', '赶': '趕', '紧': '緊',
    
    // 更多情感词汇
    '爱': '愛', '恨': '恨', '喜': '喜', '怒': '怒', '哀': '哀', '乐': '樂', '惊': '驚', '恐': '恐', '惧': '懼', '怕': '怕',
    '担': '擔', '心': '心', '忧': '憂', '虑': '慮', '愁': '愁', '苦': '苦', '痛': '痛', '伤': '傷', '悲': '悲', '哭': '哭',
    '泣': '泣', '泪': '淚', '眼': '眼', '泪': '淚', '汪': '汪', '汪': '汪', '笑': '笑', '乐': '樂', '欢': '歡', '喜': '喜',
    '悦': '悅', '快': '快', '乐': '樂', '高': '高', '兴': '興', '激': '激', '动': '動', '兴': '興', '奋': '奮', '振': '振',
    
    // 更多身体部位
    '头': '頭', '脑': '腦', '发': '髮', '眉': '眉', '眼': '眼', '鼻': '鼻', '嘴': '嘴', '唇': '唇', '齿': '齒', '牙': '牙',
    '舌': '舌', '喉': '喉', '颈': '頸', '肩': '肩', '臂': '臂', '肘': '肘', '腕': '腕', '手': '手', '指': '指', '掌': '掌',
    '拳': '拳', '胸': '胸', '背': '背', '腰': '腰', '腹': '腹', '臀': '臀', '腿': '腿', '膝': '膝', '脚': '腳', '趾': '趾',
    
    // 更多医疗健康词汇
    '病': '病', '症': '症', '疾': '疾', '患': '患', '疼': '疼', '痛': '痛', '酸': '酸', '麻': '麻', '痒': '癢', '肿': '腫',
    '胀': '脹', '炎': '炎', '热': '熱', '烧': '燒', '烫': '燙', '冷': '冷', '凉': '涼', '寒': '寒', '冻': '凍', '僵': '僵',
    '硬': '硬', '软': '軟', '松': '鬆', '紧': '緊', '粗': '粗', '细': '細', '厚': '厚', '薄': '薄', '滑': '滑', '糙': '糙',
    
    // 更多交通工具
    '车': '車', '汽': '汽', '火': '火', '电': '電', '自': '自', '行': '行', '摩': '摩', '托': '托', '船': '船', '艇': '艇',
    '舟': '舟', '筏': '筏', '帆': '帆', '桨': '槳', '舵': '舵', '锚': '錨', '缆': '纜', '绳': '繩', '索': '索', '链': '鏈',
    '飞': '飛', '机': '機', '直': '直', '升': '升', '战': '戰', '斗': '鬥', '轰': '轟', '炸': '炸', '客': '客', '货': '貨',
    
    // 更多建筑词汇
    '楼': '樓', '房': '房', '屋': '屋', '舍': '舍', '宅': '宅', '院': '院', '墙': '牆', '壁': '壁', '门': '門', '窗': '窗',
    '户': '戶', '扇': '扇', '框': '框', '台': '臺', '阶': '階', '梯': '梯', '栏': '欄', '杆': '桿', '柱': '柱', '梁': '梁',
    '檩': '檩', '椽': '椽', '瓦': '瓦', '砖': '磚', '石': '石', '木': '木', '竹': '竹', '钢': '鋼', '铁': '鐵', '铜': '銅',
    
    // 更多学习教育词汇
    '学': '學', '校': '校', '院': '院', '系': '系', '科': '科', '班': '班', '级': '級', '组': '組', '队': '隊', '社': '社',
    '团': '團', '会': '會', '部': '部', '委': '委', '员': '員', '长': '長', '主': '主', '任': '任', '师': '師', '生': '生',
    '童': '童', '徒': '徒', '弟': '弟', '课': '課', '堂': '堂', '节': '節', '章': '章', '节': '節', '段': '段', '篇': '篇',
    '题': '題', '目': '目', '问': '問', '答': '答', '解': '解', '释': '釋', '说': '說', '明': '明', '讲': '講', '述': '述',
    
    // 更多工作职业词汇
    '职': '職', '业': '業', '工': '工', '作': '作', '岗': '崗', '位': '位', '务': '務', '责': '責', '任': '任', '义': '義',
    '权': '權', '利': '利', '益': '益', '薪': '薪', '资': '資', '酬': '酬', '劳': '勞', '奖': '獎', '金': '金', '补': '補',
    '贴': '貼', '津': '津', '贴': '貼', '福': '福', '利': '利', '保': '保', '险': '險', '养': '養', '老': '老', '医': '醫',
    
    // 更多娱乐休闲词汇
    '游': '遊', '戏': '戲', '玩': '玩', '乐': '樂', '娱': '娛', '休': '休', '闲': '閒', '趣': '趣', '味': '味', '兴': '興',
    '致': '致', '爱': '愛', '好': '好', '喜': '喜', '欢': '歡', '迷': '迷', '恋': '戀', '痴': '痴', '狂': '狂', '热': '熱',
    '衷': '衷', '钟': '鍾', '情': '情', '专': '專', '注': '注', '集': '集', '中': '中', '专': '專', '心': '心', '致': '致',
    
    // 更多购物消费词汇
    '买': '買', '卖': '賣', '购': '購', '销': '銷', '售': '售', '价': '價', '格': '格', '钱': '錢', '币': '幣', '元': '元',
    '角': '角', '分': '分', '厘': '厘', '毫': '毫', '丝': '絲', '忽': '忽', '微': '微', '纳': '納', '皮': '皮', '飞': '飛',
    '阿': '阿', '托': '托', '仄': '仄', '普': '普', '托': '托', '费': '費', '米': '米', '皮': '皮', '米': '米', '纳': '納',
    
    // 更多数量单位词汇
    '个': '個', '只': '隻', '条': '條', '根': '根', '支': '支', '枝': '枝', '株': '株', '棵': '棵', '颗': '顆', '粒': '粒',
    '滴': '滴', '点': '點', '丝': '絲', '缕': '縷', '束': '束', '把': '把', '握': '握', '捧': '捧', '抱': '抱', '怀': '懷',
    '袋': '袋', '包': '包', '盒': '盒', '箱': '箱', '桶': '桶', '罐': '罐', '瓶': '瓶', '杯': '杯', '碗': '碗', '盘': '盤',
    
    // 更多方位词汇
    '东': '東', '南': '南', '西': '西', '北': '北', '中': '中', '央': '央', '内': '內', '外': '外', '左': '左', '右': '右',
    '前': '前', '后': '後', '上': '上', '下': '下', '高': '高', '低': '低', '远': '遠', '近': '近', '里': '裡', '外': '外',
    '边': '邊', '侧': '側', '旁': '旁', '角': '角', '落': '落', '隅': '隅', '端': '端', '头': '頭', '尾': '尾', '顶': '頂',
    
    // 更多抽象概念词汇
    '思': '思', '想': '想', '念': '念', '虑': '慮', '考': '考', '虑': '慮', '忆': '憶', '记': '記', '忘': '忘', '梦': '夢',
    '幻': '幻', '想': '想', '象': '象', '像': '像', '似': '似', '若': '若', '如': '如', '同': '同', '异': '異', '别': '別',
    '差': '差', '距': '距', '离': '離', '间': '間', '隔': '隔', '断': '斷', '续': '續', '连': '連', '接': '接', '合': '合',
    
    // 更多动作词汇
    '拿': '拿', '取': '取', '放': '放', '置': '置', '摆': '擺', '排': '排', '列': '列', '队': '隊', '站': '站', '坐': '坐',
    '躺': '躺', '卧': '臥', '睡': '睡', '醒': '醒', '起': '起', '立': '立', '倒': '倒', '跌': '跌', '摔': '摔', '跳': '跳',
    '蹦': '蹦', '跃': '躍', '跨': '跨', '越': '越', '过': '過', '穿': '穿', '越': '越', '渡': '渡', '过': '過', '通': '通',
    
    // 更多状态词汇
    '开': '開', '关': '關', '启': '啟', '闭': '閉', '合': '合', '分': '分', '离': '離', '散': '散', '聚': '聚', '集': '集',
    '合': '合', '并': '並', '联': '聯', '结': '結', '连': '連', '接': '接', '断': '斷', '裂': '裂', '破': '破', '碎': '碎',
    '完': '完', '整': '整', '全': '全', '部': '部', '分': '分', '半': '半', '少': '少', '多': '多', '够': '夠', '足': '足',
    
    // 更多程度词汇
    '很': '很', '非': '非', '常': '常', '特': '特', '别': '別', '格': '格', '外': '外', '尤': '尤', '其': '其', '更': '更',
    '最': '最', '极': '極', '超': '超', '级': '級', '顶': '頂', '级': '級', '一': '一', '流': '流', '头': '頭', '等': '等',
    '高': '高', '级': '級', '低': '低', '级': '級', '初': '初', '级': '級', '中': '中', '级': '級', '高': '高', '级': '級',
    
    // 更多连接词汇
    '和': '和', '与': '與', '同': '同', '及': '及', '以': '以', '及': '及', '还': '還', '有': '有', '或': '或', '者': '者',
    '要': '要', '么': '麼', '不': '不', '是': '是', '就': '就', '是': '是', '而': '而', '且': '且', '并': '並', '且': '且',
    '况': '況', '且': '且', '何': '何', '况': '況', '更': '更', '何': '何', '况': '況', '别': '別', '说': '說', '不': '不',
    
    // 更多语气词汇
    '啊': '啊', '呀': '呀', '哎': '哎', '唉': '唉', '哦': '哦', '噢': '噢', '嗯': '嗯', '哼': '哼', '哈': '哈', '嘿': '嘿',
    '嘻': '嘻', '呵': '呵', '咦': '咦', '咯': '咯', '呗': '唄', '吧': '吧', '呢': '呢', '吗': '嗎', '么': '麼', '的': '的',
    '了': '了', '着': '著', '过': '過', '来': '來', '去': '去', '起': '起', '来': '來', '下': '下', '去': '去', '上': '上'
};
